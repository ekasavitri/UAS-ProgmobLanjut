...
public class RangkumanActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Rangkuman Keuangan");
    ...
    private class MyAdapterRevenue extends ArrayAdapter {
        ...
        //konstruktor
        public MyAdapterRevenue(RangkumanActivity rangkumanActivity, String[] list_deskripsi, String list_kategori[], String list_jumlah[], String list_tanggal[]) {
            super(rangkumanActivity, R.layout.item_pendapatan, list_deskripsi);
            activity = rangkumanActivity;
    ...
    private class MyAdapterExpense extends ArrayAdapter {
        ...
        //konstruktor
        public MyAdapterExpense(RangkumanActivity rangkumanActivity, String[] list_deskripsi, String list_kategori[], String list_jumlah[], String list_tanggal[]) {
            super(rangkumanActivity, R.layout.item_pengeluaran, list_deskripsi);
            activity = rangkumanActivity;
            this.list_deskripsi = list_deskripsi;
            this.list_kategori  = list_kategori;
            this.list_jumlah    = list_jumlah;
    ...
    //load kategori dan masukkan ke dalam spinner
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            Intent intent = new Intent(RangkumanActivity.this, MainActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_dompet) {
            Toast.makeText(this, "Rangkuman", Toast.LENGTH_SHORT).show();
        } else if (id == R.id.nav_kategori_pendapatan) {
            Intent intent = new Intent(RangkumanActivity.this, KategoriPendapatan.class);
            startActivity(intent);
        } else if (id == R.id.nav_kategori_pengeluaran) {
            Intent intent = new Intent(RangkumanActivity.this, KategoriPengeluaran.class);
            startActivity(intent);
        } else if (id == R.id.nav_monthly) {
            Intent intent = new Intent(RangkumanActivity.this, ReportActivity.class);
            startActivity(intent);
